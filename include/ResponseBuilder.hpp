...
class ResponseBuilder
{
	public:
		...
		std::string		getPath(const std::string root, const std::string locPrefix, const std::string uri, const std::vector<std::string> index);
		std::string		generateFilename(const HttpRequest &request);
